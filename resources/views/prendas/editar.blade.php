@extends('layouts.stilo2')

@section('tabla')
    <div class="container-xl">
        <section class="section">
            <div class="section-header">
                <h3 class="page__heading">EDITAR PRENDA</h3>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                {!! Form::model($prenda, ['method' => 'PATCH', 'route' => ['prendas.update', $prenda->id]]) !!}
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                        <div class="form-group">
                                            <label for="image_path">Direccion de imagen</label>
